...
const defaultServiceName = 'PandaHub'
...
const buildHubServiceDefinition = (options?: {
  name?: string | null
...
const parseHubServiceCommand = (argv: string[]) => {
...
export const manageJamiexiongrHubService = async (options?: {
  argv?: string[]
  env?: NodeJS.ProcessEnv
  logger?: LoggerLike
}) => {
